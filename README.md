...
* `git clone git@github.com:rumblex/angularattack2016-cenito.git`

* `cd angularattack2016-cenito`
...
If receive the error message `"You do not have permission to publish to cenito.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add calahatras@gmail.com,andreas.krantz@cenito.se,dan.persson@cenito.se,sasha@vincic.org`
